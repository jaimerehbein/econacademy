...
<header class="mb-24">
    <div class="flex items-center gap-4 mb-4">
        <span class="text-amber-500 font-black text-[10px] uppercase tracking-[0.4em]">Módulo 03</span>
        <div class="w-8 h-px bg-white/20"></div>
    </div>
    <h1 class="text-4xl md:text-6xl font-black text-white tracking-tighter leading-none mb-6">
        TRABAJO Y REMUNERACIÓN
    </h1>
    <p class="text-slate-400 text-sm uppercase tracking-[0.2em] font-medium">Productividad y Capital Humano</p>
</header>
...
<div class="space-y-12 text-slate-300 text-lg leading-relaxed">
    ...
    <!-- SECTION 1 -->
    <section>
        <h2 class="text-xl font-bold text-white mb-6 uppercase tracking-tight border-b border-white/5 pb-2">01. El Límite del Salario</h2>
        <p class="mb-4">
            Los salarios no se basan en la moral o el esfuerzo, sino en la **productividad real** y la escasez de habilidades.
        </p>
        <ul class="list-none space-y-4">
            <li class="flex gap-3">
                <span class="text-amber-500 font-bold">•</span>
                <span>**Productividad Marginal:** Ningún empleador puede pagar más del valor que el trabajador produce sin quebrar.</span>
            </li>
            <li class="flex gap-3">
                <span class="text-amber-500 font-bold">•</span>
                <span>**Capital Humano:** El salario es el retorno sobre la inversión en habilidades y experiencia del trabajador.</span>
            </li>
        </ul>
    </section>
    ...
    <!-- SECTION 2 -->
    <section>
        <h2 class="text-xl font-bold text-white mb-6 uppercase tracking-tight border-b border-white/5 pb-2">02. La Trampa del Salario Mínimo</h2>
        <p class="mb-6">
            Fijar un precio mínimo por encima del valor de mercado crea un **excedente de mano de obra** (desempleo).
        </p>
        <div class="bg-red-500/5 border border-red-500/20 p-6 rounded-xl">
            <h3 class="text-red-400 font-bold text-sm mb-2">Impacto en Minorías</h3>
            <p class="text-sm">Al hacer ilegal trabajar por menos de una cifra arbitraria, se cortan los peldaños inferiores de la escalera del éxito, perjudicando a jóvenes e inexpertos.</p>
        </div>
    </section>

    <!-- SECTION 3 -->
    <section>
        <h2 class="text-xl font-bold text-white mb-6 uppercase tracking-tight border-b border-white/5 pb-2">03. Seguridad Laboral vs. Oportunidad</h2>
        <p class="mb-4">
            Las leyes que dificultan el despido funcionan como un impuesto a la contratación:
        </p>
        <ul class="list-disc pl-6 space-y-2 text-sm text-slate-400">
            <li>Aumentan el riesgo de contratar personal nuevo.</li>
            <li>Incentivan la automatización y el outsourcing.</li>
            <li>Protegen a quienes ya tienen empleo a costa de quienes buscan entrar (outsiders).</li>
        </ul>
    </section>
    ...
    <section class="bg-amber-500/5 border border-amber-500/20 p-8 rounded-2xl">
        ...
        <ul class="grid gap-4 md:grid-cols-2 text-sm">
            <li class="flex gap-3">
                ...
                <span>La productividad es el único techo salarial sostenible.</span>
            </li>
            <li class="flex gap-3">
                <div class="w-1 h-1 bg-amber-500 rounded-full mt-1.5 grayscale shrink-0"></div>
                <span>El salario mínimo es una ley contra los inexpertos.</span>
            </li>
            <li class="flex gap-3">
                <div class="w-1 h-1 bg-amber-500 rounded-full mt-1.5 grayscale shrink-0"></div>
                <span>Los beneficios obligatorios reducen el salario neto.</span>
            </li>
            <li class="flex gap-3">
                <div class="w-1 h-1 bg-amber-500 rounded-full mt-1.5 grayscale shrink-0"></div>
                <span>El capital (máquinas) eleva el salario del trabajador.</span>
            </li>
        </ul>
    </section>
...
<div class="my-16">
    <div class="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-8">
        ...
        <h3 class="text-white font-bold text-lg sm:text-xl break-words leading-tight">Esquema Conceptual Módulo EB3</h3>
    </div>
