...
<div class="flex items-center gap-4 md:gap-5 mt-10 md:mt-16 mb-6">
    ...
    <div>
        <h2 class="text-xl md:text-3xl font-black tracking-tight bg-gradient-to-r from-indigo-300 to-violet-400 bg-clip-text text-transparent">Fundamentos de la Teoría de Juegos: Interacción Estratégica y Equilibrio</h2>
...
<div class="flex items-center gap-4 md:gap-5 mt-10 md:mt-16 mb-6">
    <span class="text-2xl md:text-3xl drop-shadow-md">🔢</span>
    <div>
        <h2 class="text-xl md:text-3xl font-black tracking-tight bg-gradient-to-r from-cyan-300 to-blue-400 bg-clip-text text-transparent">Modelización Avanzada de Oligopolio: El Modelo de Stackelberg</h2>
...
<div class="my-16">
    <div class="flex items-center gap-3 mb-8">
        ...
        <h3 class="text-white font-bold text-xl">Esquema Conceptual Módulo MIC3</h3>
    </div>
