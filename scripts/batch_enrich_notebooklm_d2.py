...
- Usa ## para los temas principales (ej. 21.1) y ### o #### para todos los subtemas exactos del temario.
...
async def run_batch():
    ...
    # Processing A11 through A20 for the next batch
    target_codes = ["A11", "A12", "A13", "A14", "A15", "A16", "A17", "A18", "A19", "A20"]
